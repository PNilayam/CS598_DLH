...
parser.add_argument('--sent_dim', type=int, default=80,
    help='Number of fixed sentences for convolution. Will fill up to this and remainder 0s')
parser.add_argument('--embed_dim', type=int, default=768,
    help='Number of text embedding dimensions')
...
# Normalizer not required for notes data
# if args.deep_supervision:
